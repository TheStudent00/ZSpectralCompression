---
id: zspectral.findings.one_dimensional_behaviour.check
---

# CHECK — 0_5_0_one_dimensional_behaviour

Node `zspectral.findings.one_dimensional_behaviour`. Status `draft`.
