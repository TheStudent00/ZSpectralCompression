---
id: zspectral.evaluation.rate_distortion_optimizer.check
---

# CHECK — 0_4_1_rate_distortion_optimizer

Node `zspectral.evaluation.rate_distortion_optimizer`. Status `draft`.
